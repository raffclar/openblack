...
bool CreatureBody::LoadCreatureMeshes()
{
	...
	// Split into base, good, evil, fat, thin, strong and weak
...
{
	// Given the characteristics of a creature, return a custom mesh
	const auto species = creature.species;

	// Meshes are not rendering correctly
	if (species == Species::Gorilla || species == Species::GiantApe || species == Species::Chimp || species == Species::Mandrill)
	{
//		return _baseMeshes.find(Species::Cow)->second;
	}
